...
const Login = () => {
  return (
	...
	<form  action="" className="space-y-6">
		...
		<button className="block w-full p-3 text-center rounded-sm  dark:bg-blue-600 text-white">Sign in</button>
	</form>
	<div className="flex items-center pt-4 space-x-1">
		<div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
		<p className="px-3 text-sm dark:text-gray-800">Login with social accounts</p>
		<div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
	</div>
	...
	<p className="text-xs text-center sm:px-6 dark:text-gray-800">Don't have an account?
		<Link rel="noopener noreferrer" to="/signUp" className="underline text-blue-600">Sign up</Link>
	</p>
</div>
    </div>
  );
