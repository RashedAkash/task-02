  ...
  return (
	...
	<div className="divide-y dark:divide-gray-700">
		<ul className="pt-2 pb-4 space-y-1 text-sm">
			...
			<li>
				<NavLink rel="noopener noreferrer" to="/dashboard/createTask" className="flex items-center p-2 space-x-3 rounded-md">
					<FaRegUser />
					<span>Create Task</span>
				</NavLink>
			</li>
			<li>
				<NavLink rel="noopener noreferrer" to="/dashboard/showTask" className="flex items-center p-2 space-x-3 rounded-md">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
